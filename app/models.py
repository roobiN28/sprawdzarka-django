...
class Solution(models.Model):
    ...
    test_id = models.ForeignKey('app.Test', related_name='test_id', on_delete=models.CASCADE)
    testResult_id = models.ForeignKey('app.TestResult', related_name='testResult_id',on_delete=models.CASCADE)
